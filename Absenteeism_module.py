...
# Create the special class that we are going to use for here on to new data
class absenteeism_model():
    ...
    def load_and_clean_data(self, data_file):
        ...
        # create a separate dataframe, containing dummy valyes for ALL avaiable reasons
        ...
        # concate df and the 4 type of reason for absence
        ...
        column_name_upd = ['Reason_1', 'Reason_2', 'Reason_3', 'Reason_4', 'Month Value', 'Day of the Week', 
                           'Transportation Expense', 'Distance to Work', 'Age','Daily Work Load Average', 'Body Mass Index', 'Education',
                           'Children', 'Pets', 'Absenteeism Time in Hours']
        df = df[column_name_upd]

        # map 'Education' variable; the result is a dummy
    ...
    # a function which outputs the probabilities of a data point to be 1
